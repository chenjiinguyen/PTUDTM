    ...
    public class ExcelTemplate
    {
        public class TemplateExcel
        {
            ...
            private static void FillWorksheetData(DataSet data, ExcelWorksheet ws, ExcelNamedRange n, string[] deliminator)
            {
                ...
                {
                    var a = t.Address;
                    if (int_between.Between(n.Start.Row,a.Start.Row, a.End.Row) &&
                        int_between.Between(n.Start.Row, a.Start.Column, a.End.Column))
                    {
        ...
        {
            internal static bool Between(int v, int a, int b)
            {
                return v >= a && v <= b;
            }
        }
